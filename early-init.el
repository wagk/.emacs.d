  ...
  (let ((sarasa-mono (font-spec :family "Sarasa Mono J" :size --default-font-size))
    ...
    (cond
     ((find-font sarasa-mono)
      (set-frame-font sarasa-mono nil t t)
     ...
     ((find-font iosevka-slab)
      (set-frame-font iosevka-slab nil t t)
      (custom-set-faces `(fixed-pitch ((default . (:font ,iosevka-slab))))
                        `(variable-pitch ((default . (:font ,iosevka-slab))))
                        `(fixed-pitch-serif ((default . (:font ,iosevka-slab))))))
     ((and (not (find-font iosevka-slab)) (find-font iosevka))
      (set-frame-font iosevka nil t t)
