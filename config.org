...
(defun --set-fonts ()
  (cond
   ((find-font (font-spec :name "Sarasa Mono J Nerd Font"))
    (set-frame-font "Sarasa Mono J Nerd Font-14" nil t)
    (custom-set-faces '(fixed-pitch ((t (:family "Sarasa Mono J Nerd Font")))))
    (custom-set-faces '(variable-pitch ((t (:family "Sarasa Mono J Nerd Font")))))
    (custom-set-faces '(fixed-pitch-serif ((t (:family "Sarasa Mono J Nerd Font"))))))
...
(with-eval-after-load 'elpaca
  (add-hook 'elpaca-after-init-hook #'--set-fonts))
