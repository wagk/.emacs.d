...
#+begin_src emacs-lisp :results output silent
  (use-package tab-bar
    ...
    (tab-bar-tab-inactive ((t (:inherit default :italic nil))))
    (tab-bar-tab ((((background light)) (:inherit default
                                         :bold t))
                  (((background dark)) (:inherit default
                                        :bold t))))
    :custom
...
#+begin_src emacs-lisp :results output silent
  (use-package org-roam
    ...
    (:states 'normal
     ...
     "j j" 'org-roam-dailies-today
     "j t" 'org-roam-dailies-today
     "j p" 'org-roam-dailies-yesterday)
    :custom
