    ...
    (when (boundp 'config-local-syncthing-folder)
      (let ((todo (f-join config-local-syncthing-folder "todo.org")))
        (when (f-exists-p todo)
          (customize-set-variable 'org-agenda-files
                                  (add-to-list 'org-agenda-files todo)))))
    (my-evil-define-split-vsplit-cmd "ag" #'org-agenda)
    (with-eval-after-load 'eyebrowse
      (evil-ex-define-cmd "tag" #'(lambda () (interactive)
                                    (my-new-evil-tab nil)
                                    (funcall-interactively #'org-agenda))))
    (add-to-list 'after-init-hook
                 '(lambda () (funcall-interactively 'org-agenda-list))))
#+end_src
...
#+begin_src emacs-lisp :results output silent
  (use-package org-roam
    ...
    :custom
    ;; DEBUG: Test
    (org-roam-directory (-> config-local-syncthing-folder
...
* Beancount
TODO: migrate beancount.el into this.
#+begin_src emacs-lisp :results output silent
...
#+begin_src emacs-lisp :results output silent
  ...
  ;;TODO: implement a tab version of this
