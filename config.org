...
** Names
   :PROPERTIES:
   :SOURCE:   https://github.com/Malabarba/names
   :END:
   Namespacing libary
...
*** Evil Configuration
    :PROPERTIES:
    :SOURCE:   https://github.com/atheriel/evil-ledger
    :END:
    Evilify ledger-mode
...
** Pomodoro
   :PROPERTIES:
   :SOURCE:   https://github.com/TatriX/pomidor
   :END:
...
** PlantUML
   :PROPERTIES:
   :SOURCE:   https://github.com/skuro/plantuml-mode
   :END:
...
** Help+
   ...
   [[https://www.emacswiki.org/emacs/HelpPlus][Emacswiki Link]]
...
** Macrostep
   ...
   [[https://github.com/joddie/macrostep][Github Link]]
