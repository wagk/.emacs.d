...
#+begin_src emacs-lisp :results output silent
  (use-package org-pomodoro
    ...
    (org-pomodoro-finished-sound
     (locate-user-emacs-file "notification1.wav"))
    (org-pomodoro-short-break-sound
     (locate-user-emacs-file "notification2.wav"))
    (org-pomodoro-long-break-sound
     (locate-user-emacs-file "notification3.wav"))
    :init
...
[[http://www.sastibe.de/2018/11/take-screenshots-straight-into-org-files-in-emacs-on-win10/][Source]]

Note that currently the file thing isn't really generating a correct
path.

Note that for some reason if the directory does not exist we don't
create one yet. We should.
