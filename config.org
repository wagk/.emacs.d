...
#+BEGIN_SRC emacs-lisp :results output silent
  (use-package elisp-mode
    :hook ((emacs-lisp :results output silent-mode . rainbow-delimiters-mode)
           (emacs-lisp :results output silent-mode . parinfer-mode)
           (emacs-lisp :results output silent-mode . update-evil-shift-width)))
#+END_SRC
