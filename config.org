...
#+begin_src emacs-lisp :results output silent
  (use-package org-roam
    ...
    (with-eval-after-load 'aggressive-fill-paragraph
      (add-hook 'org-roam-caputre-after-find-file-hook 'aggressive-fill-paragraph-mode))
    ...
    (let* ((template (list '("rr" "Roam Entry" plain
           ...
           (template-immediate '("rn" "Immediate Roam Entry" plain
                                 ...
                                 :unnarrowed t
                                 :immediate-finish t))
           (template-daily '("rd" "Diary Roam Entry" plain
      ...
      (customize-set-value 'org-roam-dailies-capture-template template-daily))
