...
#+begin_src emacs-lisp :results output silent
  (use-package elisp-mode
    ...
    :hook ((emacs-lisp-mode . prism-mode)
           ...
           (emacs-lisp-mode . (lambda () (setq-local comment-begin ";; "))))) ;; not working for some reason
...
#+begin_src emacs-lisp :results output silent
  (use-package deft
    ...
    (evil-define-command ex-deft-forwarding-arg (filter)
      ...
      (deft))
    (evil-ex-define-cmd "notes" 'ex-deft-forwarding-arg)
...
#+begin_src emacs-lisp :results output silent
  (use-package groovy-mode
    ...
    :hook ((groovy-mode . (lambda () (setq-local comment-start "// "))))
    :init
    (with-eval-after-load 'org-src
