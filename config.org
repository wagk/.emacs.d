...
#+begin_src emacs-lisp :results output silent
  (use-package tab-bar
    ...
    (tab-bar-tab ((t (:inherit 'font-lock-function-name-face
                      :bold t))))
    (tab-bar-tab-inactive ((t (:inherit 'font-lock-keyword-face))))
    :custom
    ...
    (when (and (boundp 'config-local-syncthing-folder)
      ...
      (customize-set-variable 'org-agenda-files
                              (-concat org-agenda-files
                                       (directory-files my-notes-folder
                                                        t "\.org$")
                                       (list (f-join
...
#+begin_src emacs-lisp :results output silent
  (use-package magit
    ...
    :hook ((git-commit-setup-hook . aggressive-fill-paragraph-mode)
           ...
           (git-commit-setup-hook . display-fill-column-indicator-mode)))
#+end_src
...
#+begin_src emacs-lisp :results output silent
  ...
  Otherwise, creates a new zettel and inserts that instead."
    ...
    (evil-ex-define-cmd "ns" 'zetteldeft-new-file-and-backlink)
    (evil-ex-define-cmd "ni" 'zetteldeft-fine-file-id-insert)
