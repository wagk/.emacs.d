...
#+begin_src emacs-lisp :results output silent
  (use-package org-agenda
    ...
    (defun my-org-super-agenda ()
      "Calls `org-agenda-list' but customized using `org-super-agenda'."
      (interactive)
      (require 'org-agenda)
    ...
    (when (boundp 'config-local-syncthing-folder)
      (when (f-exists-p my-todo-org-file)
        (customize-set-variable 'org-agenda-files
                                (add-to-list 'org-agenda-files
                                             my-todo-org-file))))
    (my-evil-define-split-vsplit-cmd "agenda" #'org-agenda)
    (with-eval-after-load 'eyebrowse
      (evil-ex-define-cmd "Tagenda" #'(lambda () (interactive)
                                        (my-new-evil-tab nil)
...
#+begin_src emacs-lisp :results output silent
  (use-package deft
    ...
    :hook (;; (deft-open-file-hook . #'(lambda ()
           ;;                            (let ((file-ext (-> (buffer-file-name)
           ;;                                                (file-name-extension))))
           ;;                              (cond
           ;;                               ((eq file-ext "org") (org-mode))
           ;;                               ((eq file-ext "md") (markdown-mode))))))
    ...
    (my-evil-define-split-vsplit-cmd "n[ote]" 'deft)
...
#+begin_src emacs-lisp :results output silent
  ...
  ;; (org-journal-after-entry-create-hook . toggle-rot13-mode)))
#+end_src
