...
#+begin_src emacs-lisp :results output silent
  (use-package nano-theme
    ...
    ;; (nano-light-faded sol-base0)
    ;; (nano-light-salient sol-green)
    ;; (nano-light-strong sol-blue)
    ;; (nano-light-popout sol-yellow)
    ;; (nano-light-critical sol-red)

    ;; (nano-dark-foreground sol-base1)
    ;; (nano-dark-background sol-base03)
    ;; (nano-dark-highlight sol-base02)
    ;; (nano-dark-subtle sol-base01)
    ;; (nano-dark-faded sol-base00)
