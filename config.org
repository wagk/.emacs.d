...
- [ ] Check on how to remove the eager macro expansion error
...
#+BEGIN_SRC emacs-lisp
  (defconst my-org-directory
    (file-name-as-directory
     (if (boundp 'my-dropbox-folder)
         (concat (directory-file-name my-dropbox-folder) "/org")
       "~/org"))
    "orgmode directory."
    )
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (defconst my-notes-directory
    (file-name-as-directory
     (if (boundp 'my-dropbox-folder)
         (concat (directory-file-name my-dropbox-folder) "/notes")
       "~/notes"))
...
#+BEGIN_SRC emacs-lisp
  (defconst my-wiki-directory
    (file-name-as-directory
     (if (boundp 'my-dropbox-folder)
         (concat (directory-file-name my-dropbox-folder) "/wiki")
       "~/wiki"))
...
#+BEGIN_SRC emacs-lisp
  (defconst my-journal-org-file
    (if (boundp 'my-dropbox-folder)
        (concat (directory-file-name my-dropbox-folder) "/org/journal_2018.org")
      "~/journal_2018.org")
...
#+BEGIN_SRC emacs-lisp
  (use-package org-capture
    ...
    (:prefix my-default-evil-leader-key
     :states 'normal
     "c c" 'helm-org-capture-templates
     "c j" '(lambda () (interactive) (org-capture nil "j"))
     "C C" '(lambda () (interactive) (org-capture nil "d")))
    (:prefix my-default-evil-leader-key
...
- [X] Journal template
- [ ] side-project related templates (org-projectile?)
