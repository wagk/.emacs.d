...
#+begin_src emacs-lisp :results output silent
  (use-package prism
    ...
    ;;   :colors
    ;;   ;; (list 'font-lock-constant-face 'font-lock-keyword-face 'font-lock-type-face 'font-lock-string-face)
    ;;   (list 'font-lock-constant-face 'font-lock-type-face 'font-lock-string-face)
    ;;   :desaturations
    ;;   (list 10 20 30)
    ;;   :lightens
    ;;   (list 0 -2.5 -5)))
...
#+begin_src emacs-lisp :results output silent
  (use-package 4clojure
    :straight (:host github :repo "losingkeys/4clojure.el")
...
#+begin_src emacs-lisp :results output silent
  (use-package rg
    ...
    (rg-define-search search-everything-in-project
      ...
      :files "everything"
      :dir project
      :menu ("Custom" "ep" "Unfiltered Project")))
#+end_src
* C++
** Indentation of 4
#+begin_src emacs-lisp :results output silent
...
#+begin_src emacs-lisp :results output silent
  (defun my-buffer-specific-shell (split-func)
    (interactive)
...
#+begin_src emacs-lisp :results output silent
  (evil-ex-define-cmd "Sshell" '(lambda () (interactive)
                                  (my-buffer-specific-shell 'evil-window-split)))
  (evil-ex-define-cmd "Vshell" '(lambda () (interactive)
                                  (my-buffer-specific-shell 'evil-window-vsplit)))
#+end_src
