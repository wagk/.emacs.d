...
** If inside {}, [], or (), newline and indent
#+begin_src emacs-lisp :results output silent
...
#+begin_src emacs-lisp :results output silent
  (use-package projectile
    ...
    (defun projectile-regenerate-ctags()
      "ctags does not take in directories as arguments. It does, however, look at the current directory"
      (interactive)
...
#+begin_src emacs-lisp :results output silent
  (use-package avy
    ...
    :config
    ;; `ace-jump-eww' expects `avy-process'
