...
** Modelines
#+begin_src emacs-lisp :results output silent
  (custom-set-faces '(mode-line ((t (:inherit mode-line :underline nil :overline nil)))))
  (custom-set-faces '(mode-line-inactive ((t (:inherit mode-line-inactive :underline nil)))))
#+end_src
