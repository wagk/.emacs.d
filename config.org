...
#+begin_src emacs-lisp :results output silent
  (use-package org-pomodoro
    ...
    :init
    (evil-ex-define-cmd "po[modoro]" 'org-pomodoro)
    (evil-ex-define-cmd "pp" 'org-pomodoro)
    :hook
    ((org-pomodoro-finished . (lambda () (alert "Pomodoro finished!")))
     (org-pomodoro-break-finished . (lambda () (alert "Pomodoro break finished!")))))
#+end_src
