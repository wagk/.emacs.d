...
#+BEGIN_SRC emacs-lisp :results output silent
  (use-package rainbow-identifiers
    ...
    :hook (rainbow-delimiters-mode . rainbow-identifiers-mode))
#+END_SRC
...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (23551 60088 960751 0) :init (23551 60088 960740 0) :init-secs (0 0 25 0) :use-package-secs (0 0 46874 0) :config (23551 60088 960730 0) :config-secs (0 0 7 0)))
