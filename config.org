...
#+begin_src emacs-lisp :results output silent
  (use-package which-key
    ...
    (which-key-side-window-location '(left bottom))
    ;; :general
    ;; (:states 'normal
    ...
    (with-eval-after-load 'ivy
      ...
      (defun --project-find-doc ()
        ...
        (let* ((case-fold-search t) ; ignore cases
               (readme-list (-keep (lambda (elem)
                                     (when (string-match "readme" elem nil t)
                                       elem))
...
#+begin_src emacs-lisp :results output silent
  (use-package nano-modeline
    ...
    ;; :custom-face
    (nano-modeline-active-status-RO ((t (:foreground ,sol-red)))) ;; not working for some reason?
