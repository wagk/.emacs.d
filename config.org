...
#+begin_src emacs-lisp :results output silent
  (with-eval-after-load 'org-brain
   (defhydra hydra-org-brain (org-brain-visualize-mode-map "")
     "
  _p_: add parent _P_: remove parent _t_: edit title
  _f_: add friend _F_: remove friend _T_: edit tags
  _c_: add child  _C_: remove child  _m_: toggle visualisation
  _*_,_h_: add child headline
  "
