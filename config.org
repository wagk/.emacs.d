...
#+begin_src emacs-lisp :results output silent
  (use-package magit
    ...
    (evil-ex-define-cmd "gp" 'magit-pull)
...
#+begin_src emacs-lisp :results output silent
  (use-package zetteldeft
    ...
    (:states 'normal
     ...
     "n f" 'zetteldeft-follow-link ;; does not seem to be working?
     "n r" 'zetteldeft-file-rename
     "n t" 'zetteldeft-avy-tag-search
     "n T" 'zetteldeft-tag-buffer
     "n l" 'zetteldeft-avy-link-search)
    :config
    (evil-ex-define-cmd "zz" 'zetteldeft-find-file)
    (evil-ex-define-cmd "zc" 'zetteldeft-new-file)
    (evil-ex-define-cmd "zs" 'zetteldeft-new-file-and-link)
    (evil-ex-define-cmd "zi" 'zetteldeft-find-file-id-insert)
    (evil-ex-define-cmd "zf" 'zetteldeft-follow-link)
    (evil-ex-define-cmd "zt" 'zetteldeft-avy-tag-search)
    (evil-ex-define-cmd "zl" 'zetteldeft-avy-link-search)
