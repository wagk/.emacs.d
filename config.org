...
#+BEGIN_SRC emacs-lisp :results output silent
  (defconst my-inbox-org-file (if (boundp 'config-local-synthing-folder)
                                  (concat config-local-synthing-folder "/notes/inbox.org")
                                (progn
                                  (error "Unable to find the synthing folder!")
                                  nil)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :results output silent
  (use-package org-capture
    ...
    :config
    (when (boundp 'config-local-synthing-folder)
...
#+BEGIN_SRC emacs-lisp :results output silent
  (evil-ex-define-cmd "in[box]" '(lambda ()
                                 (interactive)
                                 (if (boundp 'config-local-synthing-folder)
