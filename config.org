...
(use-package which-key
  :elpaca (:host github :repo "justbur/emacs-which-key")
  :demand t
  :init
  (when (featurep 'evil)
...
(use-package smartparens
  :elpaca (:host github :repo "Fuco1/smartparens")
  :defer 2
  :blackout t
...
(use-package org-fragtog
  :elpaca (:host github :repo "io12/org-fragtog")
...
(use-package org-appear
  :elpaca (:host github :repo "awth13/org-appear")
...
(use-package aggressive-fill-paragraph
  :elpaca (:host github :repo "davidshepherd7/aggressive-fill-paragraph-mode")
...
(use-package aggressive-indent
  :elpaca (:host github :repo "malabarba/aggressive-indent-mode")
...
(use-package yasnippet
  :defer 20
  :elpaca (:host github :repo "joaotavora/yasnippet")
...
(use-package auto-yasnippet
  :elpaca (:host github :repo "abo-abo/auto-yasnippet")
  :after yasnippet
  :commands (aya-create
             aya-expand)
  :custom
...
(use-package prism
  ...
  (use-package anaphora
    :elpaca (:host github :repo "rolandwalker/anaphora")))
#+end_src
...
(use-package racket-mode
  :elpaca (:host github :repo "greghendershott/racket-mode")
...
(use-package clojure-mode
  :elpaca (:host github :repo "clojure-emacs/clojure-mode")
...
(use-package rust-mode
  :elpaca (:host github :repo "rust-lang/rust-mode")
  :mode
  ("\\.rs\\'" . rust-mode)
  :custom
...
(use-package cargo-mode
  :elpaca (:host github :repo "ayrat555/cargo-mode")
  :commands
...
(use-package dumb-jump
  :elpaca (:host github :repo "jacktasia/dumb-jump")
  :config
...
(use-package json-mode
  :elpaca (:host github :repo "joshwnj/json-mode")
  :mode "\\.json\\'"
  :commands (json-mode)
  :init
  (with-eval-after-load 'org-src
...
#+begin_src emacs-lisp :results output silent
(use-package wgrep
  :elpaca (:host github :repo "mhayashi1120/Emacs-wgrep")
...
#+begin_src emacs-lisp :results output silent
(use-package rg
  :elpaca (:host github :repo "dajva/rg.el")
  :demand t
  :custom
...
(use-package clang-format
  :elpaca (:host github :repo "emacsmirror/clang-format")
...
(use-package writeroom-mode
  :elpaca (:host github :repo "joostkremers/writeroom-mode")
...
#+begin_src emacs-lisp :results output silent
(use-package helpful
  :elpaca (:host github :repo "Wilfred/helpful")
  :general
  ("C-h k"   'helpful-key
...
(use-package elisp-demos
  :after (helpful)
  :elpaca (:host github :repo "xuchunyang/elisp-demos"
...
(use-package groovy-mode
  :elpaca (:host github :repo "Groovy-Emacs-Modes/groovy-emacs-modes")
...
#+begin_src emacs-lisp :results output silent
(use-package hy-mode
  :elpaca (:host github :repo "hylang/hy-mode")
  :mode "\\.hy\\'"
  :general
  (hy-mode-map
   :states 'insert
...
#+begin_src emacs-lisp :results output silent
(use-package ob-hy
  :elpaca (:host github :repo "brantou/ob-hy")
  :after org-src)
#+end_src
...
#+begin_src emacs-lisp :results output silent
(use-package pyvenv
  :elpaca (:host github :repo "jorgenschaefer/pyvenv")
...
(use-package powershell.el
  :elpaca (:host github :repo "jschaf/powershell.el")
...
(use-package yaml-mode
  ;; :elpaca (:host github :repo "yoshiki/yaml-mode")
  :elpaca t
  :mode ("\\.yml\\'"
         "\\.yaml\\'")
  :hook
...
(use-package cmake-font-lock
  ;; :elpaca (:host github :repo "Lindydancer/cmake-font-lock")
  :elpaca t
...
#+begin_src emacs-lisp :results output silent
(use-package go-mode
  ;; :elpaca (:host github :repo "dominikh/go-mode.el")
  :elpaca t
  :mode ("\\.go\\'" . go-mode)
  :hook
...
(use-package flycheck
  :elpaca (:host github :repo "flycheck/flycheck")
  :custom
...
#+begin_src emacs-lisp :results output silent
(use-package origami
  :elpaca (:host github :repo "gregsexton/origami.el")
  :after evil
  :defer 2
  :general
  (:states 'normal
...
(use-package plantuml-mode
  :elpaca (:host github :repo "skuro/plantuml-mode")
...
#+begin_src emacs-lisp :results output silent
(use-package edn
  :elpaca (:host github :repo "expez/edn.el")
  :commands (edn-read
             edn-print-string))
#+end_src
...
(use-package engine-mode
  ;; :elpaca (:host github :repo "hrs/engine-mode" :branch "main")
  :elpaca t
  :commands defengine
  :init
...
(use-package fill-function-arguments
  :elpaca (:host github :repo "davidshepherd7/fill-function-arguments")
...
(use-package dwim-shell-command
  :elpaca (:host github :repo "xenodium/dwim-shell-command"))
#+end_src
...
(use-package scopeline
  :elpaca (:host github :repo "meain/scopeline.el" :branch "master")
...
#+begin_src emacs-lisp :results output silent
(use-package xht
  :elpaca (:type git :host nil :repo "https://git.sr.ht/~flandrew/xht"))

(use-package democratize
  :elpaca (:type git :host nil :repo "https://git.sr.ht/~flandrew/democratize")
  :config
  (with-eval-after-load 'helpful
