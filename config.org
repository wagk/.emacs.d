...
#+BEGIN_SRC emacs-lisp
  (use-package org-capture
    ...
    (:prefix my-default-evil-leader-key
     ...
     "c j" 'my-journal-capture-function
     "j j" 'my-daily-capture-function)
    (:prefix my-default-evil-leader-key
    ...
    :init
    (defun my-journal-capture-function ()
      "docstring for my-journal-capture-function"
      (interactive)
      (org-capture nil "j")
      )
    (defun my-daily-capture-function ()
      (interactive)
      (org-capture nil "d")
      )
