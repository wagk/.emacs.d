...
#+begin_src emacs-lisp :results output silent
  (use-package nroam
    ...
    (:states 'normal
      :prefix my-default-evil-leader-key
      "n r" #'my-enable-nroam-mode-maybe)
    :commands nroam-mode
    ...
    (defun my-in-org-roam-dir-p ()
      ...
      (let ((path (buffer-file-name (current-buffer))))
        (and path (f-descendant-of? org-roam-directory path))))
    (defun my-enable-nroam-mode-maybe ()
...
** Modelines
#+begin_src emacs-lisp :results output silent
  (custom-set-faces `(mode-line ((t (:underline nil :overline nil :foreground ,sol-yellow))
                                 (((background light)) (:background ,sol-base2))
                                 (((background dark)) (:background ,sol-base02)))))
  (custom-set-faces `(mode-line-inactive ((t (:underline nil :overline nil))
                                          (((background light)) (:inherit mode-line :background ,sol-base2))
                                          (((background dark)) (:inherit mode-line :background ,sol-base02)))))
#+end_src
...
** Help Key binding
#+begin_src emacs-lisp :results output silent
  (custom-set-faces '(help-key-binding ((t (:box nil :foreground ,sol-yellow)))))
#+end_src
