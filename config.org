  ...
  (evil-define-command config-ag-explicit (arg)
    ...
    (let ((search-term (if arg arg
      ...
      (if (projectile-project-p)
          (projectile-ag search-term)
        (ag search-term default-directory))))
...
#+begin_src emacs-lisp :results output silent
  (use-package ivy-todo
    :straight (:host github :repo "Kungsgeten/ivy-todo")
    :commands ivy-todo)
#+end_src
...
#+begin_src emacs-lisp :results output silent
  (use-package counsel-world-clock
    :straight (:host github :repo "kchenphy/counsel-world-clock")
