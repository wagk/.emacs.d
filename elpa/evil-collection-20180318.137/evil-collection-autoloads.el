...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-ag" '("evil-collection-ag-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-alchemist" '("evil-collection-alchemist-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-anaconda-mode" '("evil-collection-anaconda-mode-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-arc-mode" '("evil-collection-arc-mode-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-bookmark" '("evil-collection-bookmark-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-calendar" '("evil-collection-calendar-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-comint" '("evil-collection-comint-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-compile" '("evil-collection-compile-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-cus-theme" '("evil-collection-cus-theme-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-custom" '("evil-collection-custom-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-daemons" '("evil-collection-daemons-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-debbugs" '("evil-collection-debbugs-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-debug" '("evil-collection-debug-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-dired" '("evil-collection-dired-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-doc-view" '("evil-collection-doc-view-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-edebug" '("evil-collection-edebug-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-elfeed" '("evil-collection-elfeed-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-elisp-refs" '("evil-collection-elisp-refs-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-epa" '("evil-collection-epa-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-eww" '("evil-collection-eww-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-flycheck" '("evil-collection-flycheck-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-free-keys" '("evil-collection-free-keys-set")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-ggtags" '("evil-collection-ggtags-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-go-mode" '("evil-collection-go-mode-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-help" '("evil-collection-help-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-ibuffer" '("evil-collection-ibuffer-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-image" '("evil-collection-image-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-info" '("evil-collection-info-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-ivy" '("evil-collection-ivy-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-kotlin-mode" '("evil-collection-kotlin-mode-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-log-view" '("evil-collection-log-view-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-lua-mode" '("evil-collection-lua-mode-set")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-macrostep" '("evil-collection-macrostep-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-man" '("evil-collection-man-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-neotree" '("evil-collection-neotree-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-nov" '("evil-collection-nov-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-occur" '("evil-collection-occur-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-p4" '("evil-collection-p4-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-package-menu" '("evil-collection-package-menu-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-pass" '("evil-collection-pass-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-popup" '("evil-collection-popup-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-proced" '("evil-collection-proced-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-prodigy" '("evil-collection-prodigy-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-profiler" '("evil-collection-profiler-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-python" '("evil-collection-python-set")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-quickrun" '("evil-collection-quickrun-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-racer" '("evil-collection-racer-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-realgud" '("evil-collection-realgud-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-reftex" '("evil-collection-reftex-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-rjsx-mode" '("evil-collection-rjsx-mode-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-robe" '("evil-collection-robe-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-rtags" '("evil-collection-rtags-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-ruby-mode" '("evil-collection-ruby-mode-set")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-simple" '("evil-collection-simple-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-tide" '("evil-collection-tide-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-transmission" '("evil-collection-transmission-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-vc-annotate" '("evil-collection-vc-annotate-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-view" '("evil-collection-view-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-which-key" '("evil-collection-which-key-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-woman" '("evil-collection-woman-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-xref" '("evil-collection-xref-setup")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-ztree" '("evil-collection-ztree-setup")))
