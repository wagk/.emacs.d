...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces 'eva02
   ...
   `(diff-header ((,class (:italic t))))
   `(diff-hl-change ((,class (:foreground ,keyword :background ,keyword))))
   `(diff-hl-delete ((,class (:foreground ,var :background ,var))))
   `(diff-hl-insert ((,class (:foreground ,builtin :background ,builtin))))
   ...
   `(font-lock-negation-char-face ((,class (:foreground ,warning :bold t))))
   ...
   ;; `(menu ((,class (:background ,fg1 :foreground ,bg1))))
   ...
   `(org-date ((,class (:foreground ,warning2))))
   ...
   `(rainbow-delimiters-depth-5-face ((,class :foreground ,type)))
   `(rainbow-delimiters-depth-6-face ((,class :foreground ,builtin)))
