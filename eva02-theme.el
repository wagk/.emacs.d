...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-level-3 ((,class (:bold nil :foreground ,fg2))))
   `(org-level-4 ((,class (:bold nil :foreground ,fg2))))
   `(org-level-5 ((,class (:bold t :foreground ,fg3))))
   `(org-level-6 ((,class (:bold t :foreground ,fg3))))
   `(org-level-7 ((,class (:bold nil :foreground ,fg4))))
   `(org-level-8 ((,class (:bold nil :foreground ,fg4))))
